...
This simulates an AI agent that does both safe and dangerous operations
"""
import time
import os
import sys
...
print("  - 2 dangerous operations attempted")
print("  - SudoDog logged and detected all operations")
